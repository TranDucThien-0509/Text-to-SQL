...
class PipelineConfig:
    ...
    db_dir: Path = Path("D:/Uni/DS319/Project/word-level/database")          # SQLite DB files root
    ...
    # ── Execution & Repair ───────────────────────────────────────────────────
    use_execution_guided: bool = False  # execute predicted SQL and repair on failure
    use_self_repair: bool = False
